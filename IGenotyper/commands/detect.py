...
# def snp_in_phased_region(phased_regions,chrom,ref_base):
#     for hap in phased_regions:
#         for hap_chrom, hap_start, hap_end in phased_regions[hap]:
#             if int(ref_base) >= int(hap_start) and int(ref_base) <= int(hap_end):
#                 return True
#     return False
...
#             if snp_in_phased_region(phased_regions,chrom,ref_base):
