...
if [ -e ./canu.ovlStore.BUILDING/$jobname.info -a ! -e ./canu.ovlStore.BUILDING/$jobname.started ] ; then
  echo "Sorting job finished; info file './canu.ovlStore.BUILDING/$jobname.info' exists."
  exit
fi
#
#  Sort!
